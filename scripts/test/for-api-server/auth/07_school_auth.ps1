...
#
# ============================================================================
#  [!] 과금 주의 - 7.4 에서 팀을 실제로 생성하므로 AI 가 간접 호출됩니다.
#      팀 생성이 커밋되면 비동기로 팀 임베딩 갱신(LLM 추출 + 임베딩)이 돕니다.
#      예상 호출: 1회 (7.4 인증 후 팀 생성)
#      ※ 08_social_kakao 의 팀 생성은 "차단 기대"라 팀이 안 만들어지고 과금도 없습니다.
#
