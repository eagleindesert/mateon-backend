...
$intent1 = Invoke-Api -Method POST -Path "/api/matching/intents/messages" -Auth -PassThru -Title "13.5 (A) 의도 추출 1턴" -Body @{
...
if ($intent1.data.completed) {
    ...
    Assert-Test -Title "13.6 (A) 1턴 만에 완료 - 2턴 생략" -Condition $false -WarnOnly `
