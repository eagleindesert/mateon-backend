 ...
 *
 * <p>
 * 이 클래스는 {@link RoleListConverter} 의 <b>의도적 복제</b>다 — matching → teams 방향의
 * import 를 만들지 않으려고 로직을 그대로 베꼈다 (원본 주석에 그렇게 적혀 있다).
 *
 * <p>
 * 복제이기 때문에 위험한 건 "둘이 갈라지는 것"이다. 한쪽만 고쳐도 컴파일은 통과하고,
 ...
 *
 * <p>
 * 세부 규칙(빈 리스트 → null 컬럼, null 컬럼 → 빈 리스트, 콤마 한계)의 근거는
