 ...
 *
 * <p>
 * 이 컨트롤러의 상태코드는 직관에 반한다. Javadoc 은 "팀장이 아니면 403" 이라고 적혀 있지만
 ...
 *
 * <p>
 * 두 번째는 <b>빈 결과가 404 가 아니라 빈 배열</b>이라는 것. "아직 후보가 없음"은 신규 사용자의
 * 정상 상태다 (의도 추출 직후엔 흔하다).
 *
 * <p>
 * 세 번째는 {@code limit} 기본값 10 이다. 이 값은 AI 서버가 점수를 매겨 주는 상한과 맞물려
