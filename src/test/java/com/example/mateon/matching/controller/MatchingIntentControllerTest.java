 ...
 *
 * <p>
 * 여기서 제일 중요한 건 <b>"진행 중인 세션 없음"이 404 가 아니라 {@code data: null} 인 200</b>
 ...
 *
 * <p>
 * 두 번째는 <b>키 표기가 한 응답 안에서 일부러 섞여 있다</b>는 것이다. {@code missingFields}
 ...
 *
 * <p>
 * AI 서버 장애의 503/502 구분도 여기서 전선까지 확인한다 — 프론트 재시도 정책이 이 두 코드로
