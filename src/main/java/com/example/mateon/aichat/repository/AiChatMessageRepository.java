...
public interface AiChatMessageRepository extends JpaRepository<AiChatMessage, Long> {
     ...
     *
     * <p>스레드 전체가 아니라 작업 소관만 돌려준다 — 매칭 세션 복원에 게이트웨이의 되묻기
     ...
     *
     * <p>작업으로 좁히는 게 핵심이다 — 도메인만으로 거르면 같은 스레드에서 완료된 옛 작업의
     ...
     *
     * <p>여기는 작업으로 거르지 않는다 — 게이트웨이의 되묻기 턴도 사용자 눈에는 대화라서,
     * 빼고 그리면 자기가 한 말이 사라진 것처럼 보인다.
     *
     * <p>{@code LEFT JOIN FETCH} 인 이유는 응답에 도메인 이름이 실리기 때문이다. 안 하면 행마다
