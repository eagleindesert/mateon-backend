...
public class AiChatService {
     ...
     *
     * <p>
     * 위임할 곳이 있는 판정에만 부른다 — UNCLEAR/OUT_OF_SCOPE 는 task 가 null 로 남아야 한다.
     */
     ...
     *
     * <p>
     * 읽기 경로에서 부르면 안 된다 — {@code @Transactional(readOnly = true)} 안에서
