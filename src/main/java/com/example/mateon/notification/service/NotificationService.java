...
public class NotificationService {
     ...
     *
     * <p>
     * 예전엔 시작할 때 userRepository.existsById() 로 유저 존재를 확인했다. 그런데 이 요청은
     ...
     *
     * <p>
     * open-in-view=false 로 근본 원인은 막았지만, 검증 자체도 되살릴 이유가 없다. userId 는
     ...
     *
     * <p>
     * 예전엔 저장 직후 같은 트랜잭션에서 곧바로 emitter.send() 를 했다. 그런데 끊긴 연결로
     ...
     *
     * <p>
     * 이제 전송은 AFTER_COMMIT 리스너가 맡는다. 전송 실패가 영속화에 닿을 수 없고,
