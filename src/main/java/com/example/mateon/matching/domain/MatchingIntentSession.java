 ...
 *
 * <p><b>수명 상태는 여기 없다.</b> 진행 중인지, 왜 끝났는지, 방치됐는지는 상위의
 ...
 *
 * <p>※ 이름 주의 — 여기서 "session" 은 <b>도메인 작업 한 판</b>이지 채팅 스레드가 아니다.
 ...
 *
 * <p>대화 이력도 여기 없다. AI 채팅 통합 로그(ai_chat_messages)가 갖고 있고 {@link #task} 로
...
public class MatchingIntentSession {
     ...
     * AI 응답을 반영한다.
     *
     * <p>완료 전이라도 상태를 바꾸지 않는다 — 작업을 닫는 건 상위(AiDomainTaskService)의 일이다.
