...
public class ObjectStorageService {
     ...
     *
     * <p>
     * 버킷 총량 한도 검사({@link BucketCapacityGuard})가 여기 붙어 있는 이유: 업로드가 이 한
     ...
     *
     * <p>
     * 우리 버킷 URL 이 아니면 조용히 넘어간다(경고 로그). 지울 대상이 우리 버킷에 없다는
     ...
     *
     * <p>
     * URLDecoder 는 '+' 를 공백으로 되돌리는데, encodeKey 가 '+' 를 %20 으로 바꿔 두므로
     * 인코딩을 거친 값에서는 문제가 없다.
     */
